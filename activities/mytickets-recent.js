...
module.exports = async (activity) => {
  try {
    ...
    let ticketStatus = {
      title: T(activity, 'My New Tickets'),
    ...
    if (noOfTickets != 0) {
      ticketStatus = {
        ...ticketStatus,
        description: noOfTickets > 1 ? T(activity, "You have {0} new tickets assigned.", noOfTickets)
          : T(activity, "You have 1 new ticket assigned."),
        color: 'blue',
        value: noOfTickets,
        actionable: true
      };
      ...
      ticketStatus = {
        ...ticketStatus,
        description: T(activity, `You have no new tickets assigned.`),
        actionable: false
      };
    }
